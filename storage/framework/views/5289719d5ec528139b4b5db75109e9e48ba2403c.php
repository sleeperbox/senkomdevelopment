                                ...
                                <div class="col-sm-6 col-md-12 col-xl-12">
                                  <div class="card">
                                    <div class="card-body" style="margin:25px;padding:15px">
                                      ...
                                      <br/>
                                    <a href="<?php echo e(url('/datauser')); ?>" style="background:#596784" class="btn btn-primary btn-fill"><i class="fa fa-search"></i> Lihat User</a>
                                      <a href="<?php echo e(url('/tambahuser')); ?>" style="background:#596784" class="btn btn-primary btn-fill"><i class="fa fa-plus-square"></i> Tambah User</a>
                                      <br/>
                                      <br/>
                                    </div>
                                  </div>
