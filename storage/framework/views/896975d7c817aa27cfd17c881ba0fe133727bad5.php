...
<html>
<head>
    <?php echo $__env->make('template.head_user', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <script src="<?php echo e(url('https://www.google.com/recaptcha/api.js')); ?>" async defer></script>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <center><a href="#intro"><img src="<?php echo e(url('public/web/img/logosenkom.png')); ?>" width="50" alt="" title="" /></a></center><br /> 
                                <h4 class="title">Input Berita</h4>
                            </div>
                            <div class="content">
                                <form action="<?php echo e(url('/berita/apk')); ?>" method="post" role="form">
