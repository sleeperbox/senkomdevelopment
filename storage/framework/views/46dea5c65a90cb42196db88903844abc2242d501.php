...
<html>
<head>
   <?php echo $__env->make('template.head_home', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</head>
...
<header id="header">
  <div class="container-fluid">
    ...
    <div id="logo" class="pull-left">
      ...
      <a href="#intro"><img src="<?php echo e(url('public/web/img/logosenkom.png')); ?>" width="40" alt="" title="" /></a>
    </div>
    ...
    <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
          <div class="carousel-background"><img src="<?php echo e(url('public/web/img/intro-carousel/slider-image-1.jpg')); ?>" alt=""></div>
        ...
        <div class="carousel-item">
          <div class="carousel-background"><img src="<?php echo e(url('public/web/img/intro-carousel/slider-image-2.jpg')); ?>" alt=""></div>
          <div class="carousel-container">
            <div class="carousel-content">
        ...
        <div class="carousel-item">
          <div class="carousel-background"><img src="<?php echo e(url('public/web/img/intro-carousel/slider-image-3.jpg')); ?>" alt=""></div>
          <div class="carousel-container">
            <div class="carousel-content">
...
<section id="contact" class="section-bg wow fadeInUp">
    ...
    <div class="row about-cols offset-1">
      ...
      <div class="col-md-2 wow fadeInUp" id="berita">
         <?php echo $__env->make('user_component.login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>
      ...
      <div class="col-md-2 wow fadeInUp">
        ...
        <div class="form">
          <?php if(\Session::has('alert')): ?>
            ...
            <?php endif; ?>
          <form action="<?php echo e(url('/berita/kirim')); ?>" method="post" role="form">
              <?php echo e(csrf_field()); ?>
  ...
  <div class="container">
    ...
    <div class="row about-cols">
      ...
      <div class="col-md-4 wow fadeInUp">
        <div class="about-col">
          <div class="img">
            <img src="<?php echo e(url('public/web/img/about-mission.jpg')); ?>" alt="" class="img-fluid">
      ...
      <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="about-col">
          <div class="img">
            <img src="<?php echo e(url('public/web/img/about-plan.jpg')); ?>" alt="" class="img-fluid">
      ...
      <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
        <div class="about-col">
          <div class="img">
            <img src="<?php echo e(url('public/web/img/about-vision.jpg')); ?>" alt="" class="img-fluid">
    ...
    <div class="row portfolio-container">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
          <div class="portfolio-wrap">
              ...
              <figure>
                <img src="public/images/<?php echo e($image->image); ?>" class="img-fluid" alt="">
                <a href="public/images/<?php echo e($image->image); ?>" class="link-preview" data-lightbox="portfolio" data-title="App 2" title="Preview"><i class="ion ion-eye"></i></a>
...
<section id="clients" class="wow fadeInUp">
  <div class="container">
    ...
    <div class="owl-carousel clients-carousel">
      <img src="<?php echo e(url('public/web/img/clients/client-1.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
      <img src="<?php echo e(url('public/web/img/clients/client-2.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
      <img src="<?php echo e(url('public/web/img/clients/client-3.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
      <img src="<?php echo e(url('public/web/img/clients/client-4.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
      <img src="<?php echo e(url('public/web/img/clients/client-5.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
      <img src="<?php echo e(url('public/web/img/clients/client-6.png')); ?>" alt="" style="width:350px;height:150px;margin:30px">
    </div>
...
<script src="<?php echo e(url('public/web/lib/jquery/jquery.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/jquery/jquery-migrate.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/easing/easing.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/superfish/hoverIntent.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/superfish/superfish.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/wow/wow.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/waypoints/waypoints.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/counterup/counterup.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/owlcarousel/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/isotope/isotope.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/lightbox/js/lightbox.min.js')); ?>"></script>
<script src="<?php echo e(url('public/web/lib/touchSwipe/jquery.touchSwipe.min.js')); ?>"></script>
<!-- Contact Form JavaScript File -->
<script src="<?php echo e(url('public/web/contactform/contactform.js')); ?>"></script>
...
<script>
  $(document).ready(function() {
      setInterval(function () {
        $('#showdata').load('<?php echo e(url('/databerita')); ?>')
      }, 1000);
    });
    $(document).ready(function() {
      setInterval(function () {
        $('#showdatajam').load('<?php echo e(url('/databeritajam')); ?>')
      }, 1000);
    });
    $(document).ready(function() {
      setInterval(function () {
        $('#showsms').load('<?php echo e(url('/sms')); ?>')
      }, 10000);
    });    
    $(document).ready(function() {
      setInterval(function () {
        $('#showsms').load('<?php echo e(url('/telegram')); ?>')
      }, 5000);
    });
    $(document).ready(function() {
      setInterval(function () {
        $('#showsms').load('<?php echo e(url('/telegramphoto')); ?>')
      }, 5000);
    });   
</script>
<style>
